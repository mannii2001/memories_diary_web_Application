...
const UpdateMemory = () => {
  ...
  const {setCurrentId,currentId} = useContext(IdContext);
  ...
  const handleSubmit = async(e) => {
    ...
    if(!title || !date || !description){
      ...
      try {
        ...
        const response = await axios.put(`/Diarymemories/${currentId}`, requestBody, { headers });

        // Handle the response
        console.log(response.data);
        alert("Your Memory is Updated");
        setCurrentId("");
        navigate('/');
